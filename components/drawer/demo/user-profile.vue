...
<template>
  ...
  <a-drawer width="640" placement="right" :closable="false" :open="open" @close="onClose">
    ...
    <a-row>
      <a-col :span="12">
        <description-item title="Email" content="@kaoniqiwa/trina-ui@example.com" />
      </a-col>
      <a-col :span="12">
    ...
    <a-row>
      <a-col :span="24">
        <description-item title="Github">
          <template #content>
            <a href="https://github.com/kaoniqiwa/trina-ui">
              github.com/vueComponent/@kaoniqiwa/trina-ui
            </a>
          </template>
        </description-item>
      </a-col>
